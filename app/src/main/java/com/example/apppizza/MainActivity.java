...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewmodal.getAllCourses().observe(this, new Observer<List<CourseModal>>() {
            ...
            public void onChanged(List<CourseModal> models) {
                // quando os dados são alterados em nossos modelos, estamos adicionando essa lista à nossa classe de adaptador.
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(MainActivity.this, "Pizza deletada.", Toast.LENGTH_SHORT).show();
            }
        ...
        adapter.setOnItemClickListener(new CourseRVAdapter.OnItemClickListener() {
            ...
            public void onItemClick(CourseModal model) {
                // após clicar no item da visualização do reciclador, estamos abrindo uma nova atividade e passando dados para a nossa atividade.
                Intent intent = new Intent(MainActivity.this, NewCourseActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_COURSE_REQUEST && resultCode == RESULT_OK) {
            ...
            Toast.makeText(this, "Pizza salva.", Toast.LENGTH_SHORT).show();
        } else if (requestCode == EDIT_COURSE_REQUEST && resultCode == RESULT_OK) {
            int id = data.getIntExtra(NewCourseActivity.EXTRA_ID, -1);

            if (id == -1) {
                Toast.makeText(this, "Pizza não atualizada.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            Toast.makeText(this, "Pizza atualizada.", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Pizza não salva.", Toast.LENGTH_SHORT).show();
        }
    }
}
