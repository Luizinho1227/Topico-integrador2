...
public abstract class CourseDatabase extends RoomDatabase {
    // a linha abaixo é para criar uma instância para nossa classe de banco dedados.
    ...
    public static synchronized CourseDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    // estamos criando um construtor de banco de dados epassando
                    // nossa classe de banco de dados com nosso nome de bancode dados.
    ...
    private static RoomDatabase.Callback roomCallback = new
            RoomDatabase.Callback() {
                ...
                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                    super.onCreate(db);
                    // este método é chamado quando o banco de dados é criado e alinha abaixo é para preencher nossos dados.
